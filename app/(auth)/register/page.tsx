  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan opacity-10 blur-3xl rounded-full animate-pulse" style={{ animationDuration: '8s' }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-cyan-light opacity-10 blur-3xl rounded-full animate-pulse" style={{ animationDuration: '10s' }} />
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                id="terms"
                required
                className="mt-1 w-4 h-4 rounded border-border-medium bg-bg-elevated text-cyan focus:ring-2 focus:ring-cyan focus:ring-offset-2 focus:ring-offset-bg-elevated"
              />
